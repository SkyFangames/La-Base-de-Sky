      ...
      when 2
        begin 
          if bgGraphic.bitmap.nil?
            ...
            cr = i.colorRed ? (oldbg[3]&.red || 0) + ((i.colorRed - (oldbg[3]&.red || 0)) * fraction) : oldbg[3]&.red || 0
            cg = i.colorGreen ? (oldbg[3]&.green || 0) + ((i.colorGreen - (oldbg[3]&.green || 0)) * fraction) : oldbg[3]&.green || 0
            cb = i.colorBlue ? (oldbg[3]&.blue || 0) + ((i.colorBlue - (oldbg[3]&.blue || 0)) * fraction) : oldbg[3]&.blue || 0
            ca = i.colorAlpha ? (oldbg[3]&.alpha || 0) + ((i.colorAlpha - (oldbg[3]&.alpha || 0)) * fraction) : oldbg[3]&.alpha ||
