...
def pbStartOver(game_over = false)
  ...
  if $PokemonGlobal.pokecenterMapId && $PokemonGlobal.pokecenterMapId >= 0
    if game_over
      ...
      pbMessage("\\w[]\\wm\\c[13]\\l[3]" +
                _INTL("Has salido corriendo hacia un Centro Pokémon para replantear tu estrategia de combate."))
    end
    pbCancelVehicles
    Followers.clear
    ...
    if game_over
      ...
      pbMessage("\\w[]\\wm\\c[8]\\l[3]" +
                _INTL("Has salido corriendo a casa para que tu equipo no sufra más daño..."))
    else
      pbMessage("\\w[]\\wm\\c[13]\\l[3]" +
                _INTL("Has salido corriendo a casa para replantear tu estrategia de combate."))
    end
    if homedata
      pbCancelVehicles
      Followers.clear
