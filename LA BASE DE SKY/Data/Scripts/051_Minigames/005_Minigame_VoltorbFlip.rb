  ...
  def display_game_info
    loop do
      ...
      when 0
        ...
        pbMessage(_INTL("El primer número que voltees te dará esa cantidad de Monedas."))
        pbMessage(_INTL("A partir de entonces, el siguiente número que encuentres multiplicará la cantidad total de Monedas que has recolectado por ese número."))
        pbMessage(_INTL("Si es un 2, tu total se multiplicará por \"×2\"."))
        pbMessage(_INTL("Si es un 3, tu total se multiplicará por \"×3\"."))
        pbMessage(_INTL("Pero si volteas un Voltorb, se acabó el juego."))
        pbMessage(_INTL("Cuando eso sucede, perderás todas las Monedas que has recolectado en el juego actual."))
        pbMessage(_INTL("Si seleccionas \"Salir\", te retirarás del juego."))
        pbMessage(_INTL("Si llegas a un punto difícil, puede que quieras terminar el juego antes de tiempo."))
        pbMessage(_INTL("Una vez que hayas encontrado todas las cartas ocultas de 2 y 3, habrás completado el juego."))
        pbMessage(_INTL("Una vez que hayas volteado todas estas cartas, avanzarás al siguiente nivel."))
        pbMessage(_INTL("A medida que subes de nivel, podrás recibir más Monedas."))
        pbMessage(_INTL("¡Haz tu mejor esfuerzo!"))
      when 1
        pbMessage(_INTL("Los números al lado del tablero te dan una pista sobre los números ocultos en la parte posterior de los paneles."))
        pbMessage(_INTL("Cuanto mayor sea el número, más probable es que haya muchos números grandes ocultos en esa fila o columna."))
        pbMessage(_INTL("De la misma manera, puedes saber cuántos Voltorb están ocultos en la fila o columna."))
        pbMessage(_INTL("Considera cuidadosamente los totales de números ocultos y los totales de Voltorb mientras volteas los paneles."))
      when 2
        pbMessage(_INTL("Usa el botón de Acción para marcar las cartas con un símbolo de Voltorb."))
        pbMessage(_INTL("Cuando tengas una idea de si hay un Voltorb oculto en la parte posterior de una carta, márcala."))
        pbMessage(_INTL("Si deseas eliminar una marca, vuelve a marcar la carta y desaparecerá."))
      else
        return
      end
    end
